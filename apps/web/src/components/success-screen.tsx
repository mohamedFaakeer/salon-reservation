  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      ...
      <div className="w-full rounded-lg border border-teal-200 bg-teal-50 p-4">
        ...
        <p data-testid="booking-reference" className="text-2xl font-bold tracking-wide text-teal-900">
          {bookingReference}
        </p>
        <p className="mt-1 text-xs text-teal-700">Keep this — you&apos;ll need it to manage your booking.</p>
      </div>
